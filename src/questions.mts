...
const quizQuestions: Question[] = [
  ...
  {
    id: 9,
    question: "Vilket land är känt för att vara det största landet i världen till ytan?",
    answers: ["Ryssland", "USA", "Kina"],
    correctAnswer: "Ryssland"
  },
  {
    id: 10,
    question: "Vilken afrikansk nation var den första att få självständighet från Storbritannien?",
  ...
  {
    id: 16,
    question: "Vilken stad är känd för att vara byggd på kanaler och har gondoler?",
